import { C as SetupApi, E as invariant, S as getCallFrame, T as devUtils, _ as isNodeProcess, a as isCommonAssetRequest, b as getTimestamp, c as colors, d as cookieStore, f as jsonParse, g as createRequestId, i as onUnhandledRequest, m as resolveWebSocketUrl, n as decorateResponse, o as executeHandlers, p as toPublicUrl, r as normalizeResponseInit, t as handleRequest, u as stringToHeaders, v as DeferredPromise, w as Emitter, x as RequestHandler, y as statuses_default } from "./handleRequest-46sUdLyt.js";
import { n as parse$2 } from "./graphql-CqfZvNK_.js";
...
//#endregion
//#region node_modules/@mswjs/interceptors/lib/browser/getRawRequest-BTaNLFr0.mjs
...
async function parseQuery(query) {
	const { parse } = await import("./graphql-CqfZvNK_.js").then((n) => n.t).catch((error) => {
...
var GraphQLHandler = class GraphQLHandler extends RequestHandler {
	...
	static #parseOperationName(predicate, operationType) {
		...
		if (isDocumentTypeDecoration(predicate)) {
			const documentNode = parse$2(predicate.toString());
	...
	interpretResponseBody(response) {
		const parsingStream = new EventSourceParsingStream({
			message: (message) => {
				...
				if (message.retry) this[kReconnectionTime] = message.retry;
