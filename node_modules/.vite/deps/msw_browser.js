import { C as SetupApi, E as invariant$1, T as devUtils, g as createRequestId$1, h as Interceptor$1, i as onUnhandledRequest, l as isObject, m as resolveWebSocketUrl, s as attachWebSocketLogger, t as handleRequest, v as DeferredPromise$1, x as RequestHandler } from "./handleRequest-46sUdLyt.js";
...
var webSocketInterceptor = new class WebSocketInterceptor extends Interceptor$1 {
	static {
...
function handleWebSocketEvent(options) {
	webSocketInterceptor.on("connection", async (connection) => {
		...
		await onUnhandledRequest(new Request(connection.client.url, { headers: {
			upgrade: "websocket",
			connection: "upgrade"
		} }), options.getUnhandledRequestStrategy()).catch((error) => {
